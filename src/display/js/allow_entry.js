$(() => {
    ...
    xhr.addEventListener("load", function (e) {
        ...
        $('.regulatory_icon').html(display_setting.allow_card.icon_input);
        $('.regulatory_message').html(`${display_setting.allow_card.title_input}<br>${display_setting.allow_card.subtitle_input}`);
